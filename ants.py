...
class Ant(Insect):
    ...
    def can_contain(self, other):
        return self.container and other.container == False and self.ant is None
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while new_place != None:
            if new_place == hive:
                return None
            elif new_place.bees and place_changes >= self.min_range and place_changes <= self.max_range:
...
class QueenAnt(ScubaThrower):
    ...
    def action(self, colony):
        ...
        if self.true_queen == False:
            ...
            while new_place:
                if new_place.ant and new_place.ant not in self.double_damage:
                    new_place.ant.damage = (new_place.ant.damage)*2
                    self.double_damage.append(new_place.ant)
                if new_place.ant and new_place.ant.container and new_place.ant.ant and new_place.ant.ant not in self.double_damage:
                    new_place.ant.ant.damage = (new_place.ant.ant.damage)*2
                    self.double_damage.append(new_place.ant.ant)
